...
**Shared release playbook.** Walks the mandated release activities in order. **Non-strict** — the project may ship `harness/playbooks/release.md` for project-specific steps and it will win over this one.
...
4. **announce-release** — read [`announce-release.md`](../actions/announce-release.md). Default is a single CHANGELOG link; the project can override with its own announcement style.
